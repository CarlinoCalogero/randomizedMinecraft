package net.nerdshelf.randomizedminecraft.screen.abstractcurrencyfurnace;
...
public abstract class AbstractCurrencyFurnaceMenu extends RecipeBookMenu<Container> {
	...
	protected AbstractCurrencyFurnaceMenu(MenuType<?> p_38960_, RecipeType<? extends AbstractCookingRecipe> p_38961_,
			RecipeBookType p_38962_, int p_38963_, Inventory p_38964_) {
		this(p_38960_, p_38961_, p_38962_, p_38963_, p_38964_, new SimpleContainer(3), new SimpleContainerData(4));
	}

	protected AbstractCurrencyFurnaceMenu(MenuType<?> p_38966_, RecipeType<? extends AbstractCookingRecipe> p_38967_,
			RecipeBookType p_38968_, int p_38969_, Inventory p_38970_, Container p_38971_, ContainerData p_38972_) {
		...
		this.addSlot(new CurrencyFurnaceFuelSlot(this, p_38971_, 1, 56, 53));
		this.addSlot(new CurrencyFurnaceResultSlot(p_38970_.player, p_38971_, 2, 116, 35));
