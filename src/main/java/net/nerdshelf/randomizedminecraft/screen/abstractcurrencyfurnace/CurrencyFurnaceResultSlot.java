...
public class CurrencyFurnaceResultSlot extends Slot {
	...
	public CurrencyFurnaceResultSlot(Player p_39542_, Container p_39543_, int p_39544_, int p_39545_, int p_39546_) {
	...
	protected void checkTakeAchievements(ItemStack p_39558_) {
		...
		if (this.player instanceof ServerPlayer && this.container instanceof AbstractCurrencyFurnaceBlockEntity) {
			((AbstractCurrencyFurnaceBlockEntity) this.container)
					.awardUsedRecipesAndPopExperience((ServerPlayer) this.player);
		}
