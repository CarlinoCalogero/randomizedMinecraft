...
public class CurrencyFurnaceFuelSlot extends Slot {
	private final AbstractCurrencyFurnaceMenu menu;

	public CurrencyFurnaceFuelSlot(AbstractCurrencyFurnaceMenu p_39520_, Container p_39521_, int p_39522_, int p_39523_,
			int p_39524_) {
