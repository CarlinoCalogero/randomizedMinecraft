package net.nerdshelf.randomizedminecraft.block.entity.client;
...
@OnlyIn(Dist.CLIENT)
public class CurrencyEnchantTableRenderer implements BlockEntityRenderer<CurrencyEnchantmentTableBlockEntity> {
	...
	public CurrencyEnchantTableRenderer(BlockEntityRendererProvider.Context p_173619_) {
		this.bookModel = new BookModel(p_173619_.bakeLayer(ModelLayers.BOOK));
	}

	public void render(CurrencyEnchantmentTableBlockEntity p_112418_, float p_112419_, PoseStack p_112420_,
			MultiBufferSource p_112421_, int p_112422_, int p_112423_) {
		p_112420_.pushPose();
