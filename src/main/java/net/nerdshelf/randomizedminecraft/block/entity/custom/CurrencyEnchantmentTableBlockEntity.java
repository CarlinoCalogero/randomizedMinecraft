...
public class CurrencyEnchantmentTableBlockEntity extends BlockEntity implements Nameable {
	public int time;
	public float flip;
	public float oFlip;
	public float flipT;
	...
	public CurrencyEnchantmentTableBlockEntity(BlockPos p_155501_, BlockState p_155502_) {
		super(ModBlockEntities.CURRENCY_ENCHANTING_TABLE.get(), p_155501_, p_155502_);
	}
	...
	public static void bookAnimationTick(Level p_155504_, BlockPos p_155505_, BlockState p_155506_,
			CurrencyEnchantmentTableBlockEntity p_155507_) {
		p_155507_.oOpen = p_155507_.open;
		p_155507_.oRot = p_155507_.rot;
		Player player = p_155504_.getNearestPlayer((double) p_155505_.getX() + 0.5D, (double) p_155505_.getY() + 0.5D,
				(double) p_155505_.getZ() + 0.5D, 3.0D, false);
		if (player != null) {
	...
	public Component getName() {
		return (Component) (this.name != null ? this.name
				: Component.translatable("randomizedminecraftmod.container.enchant"));
	}
