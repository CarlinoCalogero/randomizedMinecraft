...
public class JumpyBlock extends Block {
	...
	public InteractionResult use(BlockState state, Level level, BlockPos blockPos, Player player, InteractionHand hand,
		...
		// Check if we are on the server and player is interacting with main hand
	...
	public void stepOn(Level level, BlockPos pos, BlockState state, Entity entity) {
		...
		if (entity instanceof LivingEntity livingEntity) {
			livingEntity.addEffect(new MobEffectInstance(MobEffects.JUMP, 200)); // 20 ticks equals to 1 second
		}
